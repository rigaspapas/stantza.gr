...
.controller( 'clientsCtrl', function ($timeout) {
    this.clients = [ 'Εκδόσεις Κέδρος', 'Βιβλιοπωλεία Παπασωτηρίου', 'Ιατρικές εκδόσεις Παρισιάνου', 'Λυχνία', 'Λιθογραφείο Πρωτοπαπά Α.Ε.', 'Λιθογραφείο Μ.Τερεζάκη & Σία Ο.Ε.', 'Λιθογραφείο Precious Αρβανιτίδης Α.Ε.', 'Λιθογραφείο Λιθογραφική ΑΒΕΕ', 'Guess Who creative team', 'Ψηφιακές εκτυπώσεις Copy Express', 'Μεταξοτυπίες print-it', 'ΘΕΤΙΣ, διαχείριση πολιτιστικής κληρονομιάς', 'Πιτσαρίες Colibri', 'Ψηφιακές εκτυπώσεις Quality Α.Ε.', 'Στάθης Βασιλείου Α.Ε., είδη αρχειοθέτησης', 'Διαλεκτική Α.Ε., είδη προβολής ' ];
} );
